    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <artist-form v-if="isEditing" v-model:name="modifiedArtist.name" v-model:country="modifiedArtist.country" v-model:artistSongs="artistSongs" v-model:linkableSongs="linkableSongs" v-model:newArtistSong="newArtistSong" :isEditing="true"
